...
and that "dogfooding in this way will enforce [this]" [-@eversShouldWebsiteUse2012].
...
This will help you get a consistent behavior between your application and the consumers. It will also avoid code duplication [...]" [@danteArchitectureHowMy2013]
...
Okta [-@AuthenticationVsAuthorization2018] describes authentication as
