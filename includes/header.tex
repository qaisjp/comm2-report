...
\abstract{
    ...
    community platform ``MTA Hub'' for users to safely share, vote on and discuss these resources.

    This project aims to analyse and discuss all the problems with the existing community platform, suggest several improvements to the existing system, and build a prototyped of an improved system.
