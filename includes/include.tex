...
\abstract{
    There is a rich ecosystem of ``resources'' (essentially software packages) built for the game MTA: San Andreas and this project aims to create a new platform
    for users to safely share, vote on and discuss these resources. This project aims to replace an existing platform that performs a similar function.
